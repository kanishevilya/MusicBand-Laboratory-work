...
public class AverageAlbumsAction implements HttpAction {
    private final UdpGateway udpGateway;
    private final JsonMapper jsonMapper;

    public AverageAlbumsAction(UdpGateway udpGateway, JsonMapper jsonMapper) {
    ...
    public void execute(HttpExchange exchange, Map<String, String> pathParams) throws Exception {
        AverageOfAlbumsCountRequest req = new AverageOfAlbumsCountRequest(RequestIdGenerator.nextId());
