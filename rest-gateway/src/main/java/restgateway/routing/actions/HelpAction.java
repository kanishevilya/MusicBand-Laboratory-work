...
public class HelpAction implements HttpAction {
    private final UdpGateway udpGateway;
    private final JsonMapper jsonMapper;

    public HelpAction(UdpGateway udpGateway, JsonMapper jsonMapper) {
    ...
    public void execute(HttpExchange exchange, Map<String, String> pathParams) throws Exception {
        HelpRequest req = new HelpRequest(RequestIdGenerator.nextId());
