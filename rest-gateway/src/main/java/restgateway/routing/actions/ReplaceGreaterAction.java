...
public class ReplaceGreaterAction implements HttpAction {
    private final UdpGateway udpGateway;
    private final JsonMapper jsonMapper;

    public ReplaceGreaterAction(UdpGateway udpGateway, JsonMapper jsonMapper) {
    ...
    public void execute(HttpExchange exchange, Map<String, String> pathParams) throws Exception {
        try {
            ...
            try (InputStream is = exchange.getRequestBody()) {
                ...
                ReplaceGreaterRequest req = new ReplaceGreaterRequest(RequestIdGenerator.nextId(), key, band);
