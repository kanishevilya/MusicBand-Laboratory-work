...
public class RouteConfigurator {
    ...
    public static void configure(RestRouter router, UdpGateway udpGateway, JsonMapper jsonMapper) {
        // --- Базовые операции и получение списков (GET) ---
        ...
        // --- Выборки, агрегации и фильтры (GET) ---
        ...
        // --- Модификация и добавление данных (POST / PUT) ---
        // ИСПРАВЛЕНО: перенесли {key} в подпапку /key/, чтобы не было конфликтов со статическими путями
        ...
        // --- Управление сессиями выполнения скриптов (POST) ---
